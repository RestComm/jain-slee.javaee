...
public class SubsystemParsingTestCase extends AbstractSubsystemTest {
    ...
    public SubsystemParsingTestCase() {
        super(ConnectivityExtension.SUBSYSTEM_NAME, new ConnectivityExtension());
    }
    ...
    public void testParseSubsystem() throws Exception {
        ...
        String subsystemXml =
                "<subsystem xmlns=\"" + ConnectivityExtension.NAMESPACE + "\">" +
                        "</subsystem>";
        ...
        Assert.assertEquals(ConnectivityExtension.SUBSYSTEM_NAME, element.getValue());
    }
    */
    ...
    public void testInstallIntoController() throws Exception {
        ...
        Assert.assertTrue(model.get(SUBSYSTEM).hasDefined(ConnectivityExtension.SUBSYSTEM_NAME));
    }
    */
    ...
    public void testDescribeHandler() throws Exception {
        ...
        describeOp.get(OP_ADDR).set(
                PathAddress.pathAddress(
                        PathElement.pathElement(SUBSYSTEM, ConnectivityExtension.SUBSYSTEM_NAME)).toModelNode());
